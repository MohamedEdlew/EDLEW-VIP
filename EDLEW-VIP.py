...
os.system("espeak -a 300 \"UPDATE VERSION 2.0V,\"")
time.sleep(2)
...
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[𝙁𝙖𝙘𝙚𝙗𝙤𝙤𝙠                 • 𝐀𝐙 𝐗𝐑-𝐥𝐥     \033[1;97m  
╠══[𝙒𝙝𝙖𝙩𝙨𝙖𝙥𝙥                 • +218*******  ║\33[1;35m  
╠══[𝙑𝙀𝙍𝙎𝙄𝙊𝙉                  • V 2.0  EDLEW-VIP    \033[1;91m
\033[0;92m╠══𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈𝙀                • @Al_WERSHAFANE    
   \033[0;92m
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝""")
...
def main_menu():
    os.system("clear")
    print(logo);lin3()
    print(f"{oo(1) }اخـتـراق مـن مـلـف 🔥")
    print(f"{oo(2) }صـيـد عـشـوائـي ✅🔥")
    print(f"{oo(3)}خـروج 💔")
    lin3()
    cp =input('|?| اختار: ')
    if cp=="1":file()
...
def file():
    os.system("clear")
    print(logo);lin3()
    file = input(f"{oo('-')}ادخـل مـسـار الـمـلـف: ")
    try:
        for x in open(file,'r').readlines():
            idx.append(x.strip())
    except:
        print(f"{oo('!')}الـمـلـف غـيـر مـوجـود 😶");time.sleep(1)
        main_menu() 
    method()
    exit()
...
--------------"""
       ...
       main_menu()
    clear()
    print('\033[1;97m[+] عـدد الـحـسـابـات لـي فـي الـمـلـف🔥 : \033[1;32m '+str(len(idx)))
